-- Fix the miscased "Ai" in the auto body repair video title.
-- The title came through verbatim from the source listing; "AI" is an
-- initialism and takes both caps. Targets the row by stable id.
